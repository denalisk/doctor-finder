...
var checkContains = require("./../js/medical-search.js").checkContains;
var villains = [
  "Rowan North", "Vigo the Carpathian", "Gozer", "James Moriarty", "Stay Puft", "Marshmallow Man", "Stay Puft Marshmallow Man", "Zuul", "Ivo Shandor", "Psychomagnotheric Slime", "ghost", "ghosts", "ghostbusters", "ghostbuster"];

var displayDoctor = function(doctorObject) {
  var specialtyString = "";
  var practiceString = "";
  if(doctorObject === "none") {
    $(".doctor-container").append("<h2>Sorry, your search didn't return anything. Try a different search, or use a different location name.</h2>");
  } else {
...
$(function() {
  ...
  $("#main-form").submit(function(event) {
    ...
    if(checkContains(villains, searchQuery)) {
      $(".bonus-div").show();
    } else {
